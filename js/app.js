...
function handleSceneAction(action) {
  const scenes = {
    ...
    laptop: `
                ...
                <p style="font-size: 1.2rem; color: #5a4a3a; margin: 15px 0;">
                    Hi there, superstar! 🌟
                </p>
...
<h2>🧮 Math Corner</h2>
    ...
    test: <h2>📝 Test Prep Station</h2>
            ...
            `);
    geography: <h2>🌍 Geography Explorer</h2>
...
case 'clock':
            ...
            openSceneModal(`
                ...
                <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 20px; margin: 15px 0; text-align: center;">
                    <p style="font-size: 3rem; margin: 10px 0; font-weight: bold;">
